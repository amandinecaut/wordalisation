...
class Visual:
    ...
    dark_green = hex_to_rgb("#502196") #hex_to_rgb("#002c1c")  # hex_to_rgb(st.get_option("theme.secondaryBackgroundColor"))
    medium_green =  hex_to_rgb("#faf9ed")#hex_to_rgb("#003821")
    bright_green = hex_to_rgb("#8a67b2") #hex_to_rgb("#00A938")  # hex_to_rgb(st.get_option("theme.primaryColor"))
        ...
        for i, col in enumerate(self.columns):
            ...
            self.fig.add_trace(
                go.Scatter(
                    ...
                    mode="markers",
                    marker={
                        "color": rgb_to_color(self.white, opacity=0.2),
                        "size": 10,
                    },
